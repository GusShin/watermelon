window.__require = function e(t, n, i) {
    ...
    AniTools: [function(e, t, n) {
        ...
        var i = {
            ...
            openUIAni: function(e, t, n, i) {
                ...
                t.runAction(cc.sequence(cc.scaleTo(n, 1).easing(cc.easeBackOut()), cc.callFunc(i)))
            },
            closeUIAni: function(e, t, n, i) {
                e.runAction(cc.fadeOut(n)),
                t.runAction(cc.sequence(cc.scaleTo(n, 0).easing(cc.easeBackIn()), cc.callFunc(i)))
            },
            ...
            fireworksAni: function(e, t, n, i) {
                for (var o = 0; o < t; o++) {
                    ...
                    r.scale = .3 + .5 * Math.random(),
                    r.position = n,
                    r.color = cc.color(this.fireColorArr[this.returnRanNum(0, this.fireColorArr.length - 1)]),
                    e.addChild(r, 88);
            ...
            addNodeAni: function(e, t, n, i, o, r, a) {
                ...
                h.name = n,
                h.speed = a,
                h.wrapMode = r ? cc.WrapMode.Loop : cc.WrapMode.Normal,
                c.addClip(h)
            },
    ...
    EditorAsset: [function(e, t, n) {
        "use strict";
        cc._RF.push(t, "e34dc/R699HfbXc9cgT15Ly", "EditorAsset"),
        Object.defineProperty(n, "__esModule", {
            value: !0
        });
        var i = function() {
            function e() {}
            return e.load = function(e, t, n) {
    ...
    FloatScore: [function(e, t, n) {
        ...
        var i = this && this.__extends || function() {
          ...
          , o = this && this.__decorate || function(e, t, n, i) {
            ...
            return r > 3 && a && Object.defineProperty(t, n, a),
            a
        }
        ;
        Object.defineProperty(n, "__esModule", {
        ...
        var r = e("./MapManager")
          ...
          , u = function(e) {
            ...
            t.prototype.init = function(e) {
                ...
                var t = e + 1;
                this.score.string = t.toString(),
                this.node.setScale(.7 + .05 * e),
                this.anim(t)
            }
            ,
            t.prototype.anim = function(e) {
                r.default.Instance.MainGame.gainScore(e),
                this.node.runAction(cc.sequence(cc.spawn(cc.moveBy(1, cc.v2(0, 150)), cc.fadeOut(1).easing(cc.easeExponentialIn())), cc.removeSelf(!0)))
            }
            ,
    ...
    Fruit: [function(e, t, n) {
        ...
        var r = e("../commonJs/GameTools")
          , a = e("../commonJs/GameConfig")
          , c = e("./MapManager")
          , s = e("./MusicManager")
          , u = e("./PoolManager")
          , l = cc._decorator
          ...
          , g = function(e) {
            function t() {
                ...
                t.moveStepCount = 0,
                t.targetFruitNum = 0,
                t.enterBeforeOrAfter = 1,
                t.pushAngle = 0,
                t.pushStepCount = 0,
                t.centralAngle = 0,
                t.backAngle = 0,
                t.backStepCount = 0,
                t.createPointTime = .015,
                t.moveDir = 1,
                t.onPath = !1,
                t.canMove = !1,
                t.match = !1,
            ...
            return i(t, e),
            t.prototype.onLoad = function() {
                this.fruitSprite = this.fruit.getComponent(cc.Sprite),
            ...
            t.prototype.init = function(e, t) {
                this.fruitSprite.spriteFrame = t,
                this.type = e,
                this.fruit.setContentSize(c.default.Instance.fruitWidthArr[this.type], c.default.Instance.fruitWidthArr[this.type]),
                this.radius = this.fruit.width / 2,
                this.collider.radius = this.radius,
                this.centralAngle = cc.misc.radiansToDegrees(4 * Math.asin(this.radius / 2 / c.default.Instance.ringRadius)),
                this.realShadow.setContentSize(5 * this.radius / 2, 4 * this.radius / 5),
                this.shadow.setPosition(cc.v2(0, c.default.Instance.fruitShadowYArr[this.type]))
            }
            ,
            t.prototype.enterPath = function(e) {
                ...
                this.onPath = !0,
                this.canMove = !0,
                this.canCreatePoint = !1;
                var t = c.default.Instance.findFruitByNum(c.default.Instance.minFruitNum);
                if (null != t) {
                    var n = t.getComponent("Fruit")
                      , i = c.default.Instance.findFruitByNum(c.default.Instance.maxFruitNum)
                      , o = !1;
                    if (c.default.Instance.minFruitNum == c.default.Instance.maxFruitNum)
                        ...
                        t.position.sub(this.node.position).mag() > i.position.sub(this.node.position).mag() && (o = !0);
                    o ? (c.default.Instance.insertFruitInNum(this.node, c.default.Instance.maxFruitNum + 1),
                    c.default.Instance.fruitAddSpeed(c.default.Instance.maxFruitNum, c.default.Instance.maxFruitNum - 1)) : (c.default.Instance.insertFruitInNum(this.node, c.default.Instance.minFruitNum),
                    c.default.Instance.fruitAddSpeedBack(this.node, c.default.Instance.minFruitNum + 1))
                } else
                    c.default.Instance.insertFruitInNum(this.node, c.default.Instance.minFruitNum),
                    this.canMove = !1,
                    a.noTouchBool = !0,
                    cc.log(a.noTouchBool)
            }
            ,
            t.prototype.collEnterPath = function(e) {
                if (!this.collEnter) {
                    ...
                    var n = (255 - this.node.getPosition().mag()) / 1700
                      , i = c.default.Instance.judgeFruitPos(this.currentAngle);
                    if (this.node.runAction(cc.moveTo(n, i)),
                    n > .08 ? this.node.runAction(cc.sequence(cc.delayTime(n), cc.callFunc(function() {
                        this.pathFruit = null,
                        this.onPath = !0,
                        c.default.Instance.judgeGameEnd() ? c.default.Instance.gameEnd() : this.judgeBothSideFruit(1)
                    }, this))) : this.node.runAction(cc.sequence(cc.delayTime(.08), cc.callFunc(function() {
                        this.pathFruit = null,
                        this.onPath = !0,
                        c.default.Instance.judgeGameEnd() ? c.default.Instance.gameEnd() : this.judgeBothSideFruit(1)
                    }, this))),
                    this.currentAngle > t.currentAngle ? this.currentAngle - t.currentAngle > 180 ? this.enterBeforeOrAfter = 1 : this.enterBeforeOrAfter = 0 : t.currentAngle - this.currentAngle > 180 ? this.enterBeforeOrAfter = 0 : this.enterBeforeOrAfter = 1,
                    1 == this.enterBeforeOrAfter) {
                        cc.log("\u5f80\u524d\u63a8\u78b0\u649e\u6c34\u679c"),
                        c.default.Instance.insertFruitInNum(this.node, this.pathFruit.num + 1);
                        var o = 0;
                        if (o = (a = this.getNextFruitAngle(t.centralAngle, 0)) < t.currentAngle ? a < t.currentAngle - 180 ? a + 360 - t.currentAngle : t.currentAngle - a : a > t.currentAngle + 180 ? t.currentAngle + 360 - a : a - t.currentAngle,
                        a < t.currentAngle && a > t.currentAngle - 180 ? c.default.Instance.pushAfterFruit(c.default.Instance.minFruitNum, this.pathFruit.num, o) : a > t.currentAngle && a > t.currentAngle + 180 ? c.default.Instance.pushAfterFruit(c.default.Instance.minFruitNum, this.pathFruit.num, o) : c.default.Instance.pushManyFruit(c.default.Instance.minFruitNum, this.pathFruit.num, o),
                        this.node.num < c.default.Instance.maxFruitNum) {
                            cc.log("\u5f80\u540e\u63a8\u78b0\u649e\u6c34\u679c\u7684\u540e\u6c34\u679c"),
                            this.pathFruit = c.default.Instance.findFruitByNum(this.node.num + 1);
                            var r = this.pathFruit.getComponent("Fruit");
                            (o = (a = this.getNextFruitAngle(r.centralAngle, 1)) > r.currentAngle ? r.currentAngle + 360 - a : r.currentAngle - a) > 180 ? (o = a - r.currentAngle,
                            c.default.Instance.pushManyFruit(this.node.num + 1, c.default.Instance.maxFruitNum, o)) : c.default.Instance.pushAfterFruit(this.node.num + 1, c.default.Instance.maxFruitNum, o)
                        }
                    } else {
                        c.default.Instance.insertFruitInNum(this.node, this.pathFruit.num),
                        cc.log("\u5f80\u540e\u63a8\u78b0\u649e\u6c34\u679c");
                        var a;
                        o = 0;
                        if ((o = (a = this.getNextFruitAngle(t.centralAngle, 1)) > t.currentAngle ? t.currentAngle + 360 - a : t.currentAngle - a) > 180 ? (o = a - t.currentAngle,
                        c.default.Instance.pushManyFruit(this.node.num + 1, c.default.Instance.maxFruitNum, o)) : c.default.Instance.pushAfterFruit(this.node.num + 1, c.default.Instance.maxFruitNum, o),
                        this.node.num > c.default.Instance.minFruitNum) {
                            cc.log("\u5f80\u524d\u63a8\u78b0\u649e\u6c34\u679c\u7684\u524d\u6c34\u679c"),
                            this.pathFruit = c.default.Instance.findFruitByNum(this.node.num - 1);
                            r = this.pathFruit.getComponent("Fruit");
                            (o = (a = this.getNextFruitAngle(r.centralAngle, 0)) < r.currentAngle ? a + 360 - r.currentAngle : a - r.currentAngle) > 180 ? (o = r.currentAngle - a,
                            c.default.Instance.pushAfterFruit(c.default.Instance.minFruitNum, this.pathFruit.num, o)) : c.default.Instance.pushManyFruit(c.default.Instance.minFruitNum, this.pathFruit.num, o)
                        }
                    }
                }
            }
            ...
            t.prototype.getNextFruitPos = function(e, t) {
                var n = this.centralAngle / 2 + e / 2
                  , i = 0;
                return i = 1 == t ? this.currentAngle - n < 0 ? 360 + this.currentAngle - n : this.currentAngle - n : this.currentAngle + n > 360 ? this.currentAngle + n - 360 : this.currentAngle + n,
                c.default.Instance.judgeFruitPos(i)
            }
            ,
            t.prototype.onCollisionEnter = function(e, t) {
                if (!(a.updateOver || (this.running && "Fruit" == e.node.group && e.node.num == this.targetFruitNum && (cc.log("\u8ffd\u8d76\u6210\u529f"),
                this.running = !1,
                this.canMove = !1,
                this.speedUp = !1,
                this.moveDir = 1,
                this.timePerRound = 10,
                this.targetFruitNum = NaN,
                c.default.Instance.revisePosFromNum(this.node.num),
                this.judgeBothSideFruit(1)),
                this.beMatch || this.match || this.entering || "Fruit" != e.node.group))) {
                    if (!e.node.getComponent("Fruit").onPath)
                        return;
            ...
            t.prototype.toMatch = function(e, t, n) {
                if (!a.updateOver) {
                    ...
                    cc.log("\u5408\u6210\u65b9\u5411" + n),
                    this.beMatch = !0,
                    this.canMove && (this.canMove = !1),
                    this.entering && (this.entering = !1,
                    this.moveStepCount = 0),
                    this.canCreatePoint && (this.canCreatePoint = !1),
                    this.onPath)
                        if (8 != this.type) {
                            var i = cc.misc.radiansToDegrees(4 * Math.asin(c.default.Instance.fruitWidthArr[this.type + 1] / 4 / c.default.Instance.ringRadius))
                              , o = this.centralAngle - (i - this.centralAngle) / 2;
                            this.node.num < e.num && this.node.num > c.default.Instance.minFruitNum ? c.default.Instance.pushAfterFruit(c.default.Instance.minFruitNum, this.node.num - 1, o) : this.node.num > e.num && this.node.num < c.default.Instance.maxFruitNum && c.default.Instance.pushManyFruit(this.node.num + 1, c.default.Instance.maxFruitNum, o),
                            1 == n ? c.default.Instance.pushAfterFruit(this.node.num + 2, c.default.Instance.maxFruitNum, (i - this.centralAngle) / 2) : 2 == n && this.node.num - 2 >= c.default.Instance.minFruitNum && c.default.Instance.pushManyFruit(c.default.Instance.minFruitNum, this.node.num - 2, (i - this.centralAngle) / 2)
                        } else
                    ...
                    void 0 != this.node.num && NaN != this.node.num && (c.default.Instance.deleteFruitByNum(this.node.num),
                    this.node.num = NaN),
                    this.node.stopAllActions(),
                    this.node.zIndex = 10;
                    var r = this.node.position.add(this.node.position.sub(e.position).normalize().mul(30 - 2 * this.type))
                      , s = 1.5 - .03 * this.type;
                    7 != this.type && 8 != this.type || (r = this.node.position.add(this.node.position.sub(e.position).normalize().mul(20 - 2 * this.type)),
                    s = 1.4 - .03 * this.type),
                    this.node.runAction(cc.sequence(cc.spawn(cc.sequence(cc.moveTo(.07, r), cc.moveTo(.13, e.position)), cc.sequence(cc.scaleTo(.13, s).easing(cc.easeSineOut()), cc.scaleTo(.07, 1).easing(cc.easeSineOut()))), cc.callFunc(function() {
                        var e = c.default.Instance.fruitArr.indexOf(this.node);
                        c.default.Instance.fruitArr.splice(e, 1),
            ...
            t.prototype.levelUp = function(e, t, n, i) {
                if (!a.updateOver)
                    ...
                    1 == i && (this.canMove = !1),
                    8 != this.type) {
                        s.default.Instance.playMusic(3, .65 + .05 * this.type, !1),
                        c.default.Instance.createParticle(this.node.position, this.type),
                        c.default.Instance.createRing(this.node.position, this.type),
                        c.default.Instance.createJuice(this.node.position, this.type),
                        c.default.Instance.createFloatScore(this.node.position, this.type);
                        ...
                        this.fruit.runAction(cc.sequence(cc.scaleTo(.2, .8).easing(cc.easeSineInOut()), cc.callFunc(function() {
                            this.fruitSprite.spriteFrame = c.default.Instance.fruitSpriteFrameArr[this.type + 1],
                            this.fruit.setContentSize(c.default.Instance.fruitWidthArr[this.type + 1], c.default.Instance.fruitWidthArr[this.type + 1])
                        }, this), cc.scaleTo(.01, o), cc.scaleTo(.09, 1).easing(cc.easeSineOut()), cc.callFunc(function() {
                            c.default.Instance.MainGame.gameBeginner && (c.default.Instance.MainGame.gameBeginner = !1),
                            this.type++,
                            this.match = !1,
                            this.radius = this.fruit.width / 2,
                            this.collider.radius = this.radius,
                            ...
                            this.realShadow.setContentSize(5 * this.radius / 2, 4 * this.radius / 5),
                            this.shadow.setPosition(cc.v2(0, c.default.Instance.fruitShadowYArr[this.type])),
                            c.default.Instance.revisePosBySelf(this.node.num),
                            cc.log("\u5408\u6210\u7ed3\u675f"),
                            c.default.Instance.judgeGameEnd() ? c.default.Instance.gameEnd() : n++
                        }, this), cc.delayTime(.1), cc.callFunc(function() {
                            this.judgeBothSideFruit(n)
                        }, this)))
                    } else
                        this.boom()
            }
            ...
            t.prototype.boom = function() {
                this.node.stopAllActions(),
                a.updateOver || this.fruit.runAction(cc.sequence(cc.delayTime(.2), cc.moveTo(.02, cc.v2(8, 7)), cc.moveTo(.02, cc.v2(-13, 3)), cc.moveTo(.02, cc.v2(3, -6)), cc.moveTo(.02, cc.v2(10, 4)), cc.moveTo(.02, cc.v2(0, 0)))),
                this.node.runAction(cc.sequence(cc.scaleTo(.2, .8).easing(cc.easeSineInOut()), cc.scaleTo(.1, 1.3).easing(cc.easeSineOut()), cc.callFunc(function() {
                    c.default.Instance.createParticle(this.node.position, this.type),
                    c.default.Instance.createRing(this.node.position, this.type),
                    c.default.Instance.createJuice(this.node.position, this.type),
                    c.default.Instance.deleteFruitByNum(this.node.num);
                    var e = c.default.Instance.fruitArr.indexOf(this.node);
                    if (c.default.Instance.fruitArr.splice(e, 1),
                    a.updateOver)
                        s.default.Instance.playMusic(5, 1, !1);
                    else {
                        cc.log("\u897f\u74dc\u7206\u70b8"),
                        s.default.Instance.playMusic(4, 1, !1),
                        c.default.Instance.createFloatScore(this.node.position, this.type),
                        c.default.Instance.createWatermelon(this.node.position),
                        c.default.Instance.cameraShake();
                        var t = this.node.num;
                        this.node.num = NaN,
                        t != c.default.Instance.maxFruitNum + 1 && t != c.default.Instance.minFruitNum ? (c.default.Instance.pushAfterFruit(c.default.Instance.minFruitNum, t - 1, this.centralAngle / 2),
                        c.default.Instance.pushManyFruit(t, c.default.Instance.maxFruitNum, this.centralAngle / 2),
                        t < c.default.Instance.maxFruitNum ? c.default.Instance.findFruitByNum(t).getComponent("Fruit").judgeBothSideFruit(t) : (a.noTouchBool = !0,
                        cc.log(a.noTouchBool))) : (a.noTouchBool = !0,
                        cc.log(a.noTouchBool))
                    }
                    this.realShadow && this.realShadow.destroy()
            ...
            t.prototype.judgeBothSideFruit = function(e) {
                if (!a.updateOver) {
                    ...
                    var t = null
                      , n = null;
                    this.node.num != c.default.Instance.maxFruitNum && (n = c.default.Instance.findFruitByNum(this.node.num + 1)),
                    this.node.num != c.default.Instance.minFruitNum && (t = c.default.Instance.findFruitByNum(this.node.num - 1));
                    var i = 0;
                    if (null != t) {
                        ...
                        if (o.type == this.type) {
                            ...
                            if (null != n)
                                (s = n.getComponent("Fruit")).type == this.type ? (i = 3,
                                s.toMatch(this.node, e, i)) : i = 1;
                            else
                                i = 1;
                            return o.toMatch(this.node, e, i),
                            void this.levelUp(r, !1, e, i)
                        }
                        if (null != n) {
                            if ((s = n.getComponent("Fruit")).type == this.type) {
                                r = n.position.sub(this.node.position).mag() / this.speed;
                                return i = 2,
                                s.toMatch(this.node, e, i),
                                void this.levelUp(r, !1, e, i)
                            }
            ...
            t.prototype.tryToOverGame = function() {
                c.default.Instance.judgeGameEnd() ? c.default.Instance.gameEnd() : c.default.Instance.operationStep >= c.default.Instance.resetOperationStepNum ? c.default.Instance.autoAddFruit() : (a.noTouchBool = !0,
                cc.log(a.noTouchBool))
            }
            ,
            t.prototype.createPoint = function() {
                var e = u.default.Spawn("point");
                e.parent = c.default.Instance.Streak,
                e.setPosition(this.node.position),
                e.setContentSize(2 * this.radius, 2 * this.radius),
                e.color = c.default.Instance.strokeColorArr[this.type],
                e.runAction(cc.sequence(cc.scaleTo(.2, 0), cc.removeSelf(!0)))
            }
            ,
            t.prototype.update = function(e) {
                if (this.deathshift && this.realShadow && this.realShadow.setPosition(r.convetOtherNodeSpaceAR(this.shadow, c.default.Instance.Shadow)),
                !a.updateOver) {
                    if (this.onPath && this.canMove) {
                        var t = this.currentAngle;
                        this.pushing && (this.pushStepCount < 5 ? (this.pushStepCount++,
                        t += this.pushAngle / 5) : (this.pushing = !1,
                        this.back || (this.canMove = !1),
                        this.pushStepCount = 0)),
                        this.back && (this.backStepCount < 5 ? (this.backStepCount++,
                        t -= this.backAngle / 5) : (this.back = !1,
                        this.pushing || (this.canMove = !1),
                        this.backStepCount = 0)),
                        this.speedUp && (t += e * (360 / this.timePerRound) * this.moveDir,
                        this.timePerRound > c.default.Instance.maxTimePerRound && (this.timePerRound -= this.addSpeed));
                        var n = cc.misc.degreesToRadians(t)
                          , i = cc.v2(c.default.Instance.ringRadius * Math.cos(n), c.default.Instance.ringRadius * Math.sin(n));
                        this.node.setPosition(i),
                        this.currentAngle = t,
                        this.currentAngle >= 360 ? this.currentAngle %= 360 : this.currentAngle <= -360 && (this.currentAngle %= -360)
                    }
                    if (this.entering)
                        if (this.moveStepCount < 5) {
                            this.moveStepCount++;
                            var o = this.pathFruit.getComponent("Fruit").getNextFruitPos(this.centralAngle, this.enterBeforeOrAfter)
                              , s = this.node.position.lerp(o, .1 * this.moveStepCount);
                    ...
                    this.canCreatePoint && (this.createPointTime -= e,
                    this.createPointTime <= 0 && (this.createPointTime = .015,
                    this.createPoint())),
                    this.realShadow && this.realShadow.setPosition(r.convetOtherNodeSpaceAR(this.shadow, c.default.Instance.Shadow))
                }
            }
            ,
    ...
    GameTools: [function(e, t, n) {
        ...
        var i = {
            ...
            PlayBgm: function(e, t) {
                var n = this.bgmId;
                cc.loader.loadRes(this.loadMusicPath + e, cc.AudioClip, function(e, i) {
                    e ? cc.error(e.message || e) : n.id = cc.audioEngine.play(i, !0, t)
                })
            },
        ...
        var i = {
            ...
            setButtonClickEvents: function(e, t, n, i, o) {
                ...
                for (var a = 0; a < r.length; a++) {
                    ...
                    c.handler = n,
                    void 0 == t.length ? c.customEventData = i : c.customEventData = a;
                    var s = r[a].addComponent(cc.Button);
                    s.clickEvents.push(c),
                    (void 0 == o || o) && (s.transition = cc.Button.Transition.SCALE,
                    s.duration = .1,
                    s.zoomScale = 1.2)
                }
            },
    ...
    LanguageSetJs: [function(e, t, n) {
        ...
        t.exports = {
            language_1: {
                game_name: "\u300c\u6c34\u679c\u5927\u738b\u300d",
                game_name1: "\u6c34\u679c\u5927\u738b",
                game_info: "\u70b9\u51fb\u5c4f\u5e55\uff0c\u53d1\u5c04\u6c34\u679c\uff0c\u76f8\u540c\u7684\u6c34\u679c\u53ef\u4ee5\u5408\u6210\u5347\u7ea7\u6210\u66f4\u9ad8\u7ea7\u7684\u6c34\u679c\u3002",
                txtStart: "\u5f00\u59cb",
                txtMore: "\u66f4\u591a\u6e38\u620f",
                txtAgain: "\u518d\u73a9\u4e00\u6b21",
                txtShare1: "\u5728\u6e38\u620f\u4e2d ",
    ...
    LoadSceneJs: [function(e, t, n) {
        ...
        var i = {
            goToCover: function(e, t, n, i, o) {
                var r = e;
                r = null == r || void 0 == r || e,
                console.log("LoadBoolBeforeLoadS", r),
                this.needShow = !1,
                r && r ? (this.needShow = !0,
                showMyAds()) : this.needShow = !1,
                this.needShow ? (void 0 == preloader && this.startGoToGame(n, i, o),
                resCompleteFlag = !0,
                adCompleteFlag && resCompleteFlag && this.startGoToGame(n, i, o)) : this.startGoToGame(n, i, o)
            },
    ...
    MainGameJS: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.adapterScreen(),
                this.UICon = this.UIManager.getComponent("UIManager"),
                this.MapCon = this.MapManager.getComponent("MapManager"),
                this.CollisionFun(),
                this.gameData = a.getData(),
                this.gameBeginner = !0,
                i.gameMaxScore = this.gameData.gameMaxScore,
                i.noTouchBool = !0,
                i.GAME_OVER_BOOL = !0,
                this.gameWidth = cc.winSize.width,
                this.gameHeight = cc.winSize.height,
                this.sceneScore.node.y = this.gameHeight / 2 - 90,
                this.bgLayer.height = this.gameHeight,
                this.bgLayer.y = -this.gameHeight / 2,
                o.loadingLayer("panel/LinkIconSpr"),
            ...
            CollisionFun: function() {
                ...
                this.manager.enabledDebugDraw = !0,
            ...
            judgeCurPlatform: function() {
                ...
                var e = function() {
                    ...
                    /(?:iPad|PlayBook)/.test(e) || i && !/(?:Mobile)/.test(e) || o && /(?:Tablet)/.test(e))
                      , a = /(?:iPhone)/.test(e) && !r;
                    return {
                        isTablet: r,
                        isPhone: a,
            ...
            PlayBgm: function(e, t) {
                var n = this;
                cc.loader.loadRes("music/" + e, cc.AudioClip, function(e, i) {
                    if (e)
                        cc.error(e.message || e);
                    else {
                        var o = cc.audioEngine.play(i, !0, t);
                        n.bgm = o
                    }
                })
            },
            addTouchEvents: function() {
                ...
                this.node.on(cc.Node.EventType.TOUCH_START, function(t) {
                    if (i.GAME_OVER_BOOL && i.noTouchBool && !i.updateOver)
                        return e.gameBeginner && e.UICon.beginnerOverAction(),
                        i.noTouchBool = !1,
                        e.MapCon.shotFruit(c.worldConvertLocalPointAR(e.MapManager, t.getLocation())),
                        !0
                }, this)
            },
            ...
            gainScore: function(e) {
                this.gameScore += e,
                this.sceneScore.string = this.gameScore.toString()
            },
            gameEnd: function() {
                this.gameOver || (cc.audioEngine.play(this.over, !1, 1),
                this.gameOver = !0,
                this.UICon.canNotTouch = !0,
                i.gameScore = this.gameScore,
                i.gameMaxScore < this.gameScore && (i.gameMaxScore = this.gameScore),
                i.GAME_OVER_BOOL = !1,
                a.setData(i.gameMaxScore),
                r.gameOverShowText(i.gameScore, 1),
    ...
    MainManage: [function(e, t, n) {
          ...
          , c = (e("GameUiTools"),
        {
            ...
            init: function(e, t, n) {
                ...
                this.gameNameText = o.game_name,
                this.gameInfoText = o.game_info,
                this.txtStartText = o.txtStart,
                this.txtMoreText = o.txtMore,
                this.txtAgainText = o.txtAgain,
                this.gameEndLText = o.gameEndL,
                this.gameEndL1Text = o.gameEndL1,
                this.bgLayRgb = o.bgRgb,
                this.gameEndName1 = o.gameT2,
            ...
            getHttpGameId: function() {
                ...
                var o = document.URL
                  , r = 0
                  , a = o.substring(o.lastIndexOf("/game/") + 1, o.length).split("/");
                a.length >= 2 && (r = a[1]),
                this.gameHttpId = r,
                cc.log("gameId", r);
            ...
            gotoEndLayer: function() {
                if (cc.find("Canvas").getComponent("MainGameJS").UICon.count++,
                console.log("\u8c03\u7528\u5e7f\u544a"),
                r.publicGameBool)
    ...
    MapManager: [function(e, t, n) {
        ...
        (function(e) {
            e[e.GS_INIT = 0] = "GS_INIT",
            e[e.GS_PLAYING = 1] = "GS_PLAYING",
            e[e.GS_END = 2] = "GS_END"
        }
        )(r || (r = {}));
        var l = function() {
          ...
          , m = function(e) {
            function t() {
                ...
                t.ring = null,
                t.sineWave = null,
                t.fruitSpriteFrameArr = [],
                t.particle1SpriteFrameArr = [],
                t.particle2SpriteFrameArr = [],
                t.ringSpriteFrameArr = [],
                t.juiceSpriteFrameArr = [],
                t.watermelonSpriteFrameArr = [],
                t.ringRadius = 255,
                t.maxFruitNum = 0,
                t.minFruitNum = 0,
                t.maxTimePerRound = 1,
                t.typeNum = 0,
                t.operationStep = 0,
                t.resetOperationStepNum = 3,
                t.autoAddFruitNum = 1,
                t.testFruitBoom = !1,
                t.fruitArr = [],
                t.pathArr = [],
                t.fruitWidthArr = [39, 55, 78, 102, 120, 142, 168, 198, 220],
                t.fruitShadowYArr = [-20, -27, -37, -50, -58, -68, -82, -94, -109],
                t.strokeColorArr = [new cc.Color(108,212,255), new cc.Color(255,118,154), new cc.Color(238,81,240), new cc.Color(255,252,66), new cc.Color(255,189,66), new cc.Color(255,128,184), new cc.Color(45,225,91), new cc.Color(178,111,59), new cc.Color(45,225,91)],
                t.typeArr = [0, 1, 2, 3, 4, 5, 6, 7, 8, 8, 7],
                t.MainGame = null,
                t.memberZIndex = {
                    fruit: 5,
                    particle: 100,
                ...
                t.sineWaveEffect = null,
                t.currentFruit = null,
                t._curState = r.GS_INIT,
                t
            }
            var n;
            return i(t, e),
            ...
            t.prototype.onLoad = function() {
                ...
                n.Instance = this,
                this.MainGame = this.mainGame.getComponent("MainGameJS"),
                this.node.width = this.MainGame.gameWidth,
                this.node.height = this.MainGame.gameHeight
            }
            ,
            t.prototype.start = function() {
                this.curState = r.GS_PLAYING,
                c.updateOver = !1,
                this.createFruit(cc.v2(0, -this.ringRadius), 0),
                this.fruitArr[0].setScale(1),
                this.fruitArr[0].getComponent("Fruit").realShadow.setScale(1),
                this.fruitArr[0].getComponent("Fruit").onPath = !0,
                this.fruitArr[0].num = 0,
                this.MainGame.gameBeginner && this.MainGame.UICon.beginnerHandAction(cc.v2(0, -this.ringRadius)),
                this.createFruit(cc.v2(0, 0), 0),
                this.currentFruit = this.fruitArr[1],
                this.fruitArr[1].setScale(1),
                this.fruitArr[1].getComponent("Fruit").realShadow.setScale(1)
            }
            ,
            Object.defineProperty(t.prototype, "curState", {
                set: function(e) {
                    ...
                    case r.GS_PLAYING:
                        setTimeout(function() {
                            t.MainGame.addTouchEvents()
                        }, .1);
                        break;
                    case r.GS_END:
                        setTimeout(function() {
                            t.MainGame.reMoveTouchEvents()
                        }, .1)
                    }
                    this._curState = e
                },
            ...
            t.prototype.createFruit = function(e, t) {
                ...
                this.Fruit.addChild(n, this.memberZIndex.fruit),
                n.setPosition(e),
                n.setScale(0);
                var i = n.getComponent("Fruit");
                i.realShadow = this.createShadow(e),
                i.init(t, this.fruitSpriteFrameArr[t]),
                this.fruitArr.push(n)
            }
            ,
            t.prototype.createShadow = function(e) {
                var t = s.default.Spawn("shadow");
                return t.parent = this.Shadow,
                t.setPosition(e),
                t
            }
            ,
            t.prototype.shotFruit = function(e) {
                cc.log("\u53d1\u5c04\u6c34\u679c");
                var t = e.sub(cc.v2(0, 0)).normalize().mul(this.ringRadius)
                  , n = this.judgeFruitAngle(t);
                u.default.Instance.playMusic(0, .3, !1),
                this.operationStep++,
                this.currentFruit.getComponent("Fruit").canCreatePoint = !0,
                this.currentFruit.runAction(cc.sequence(cc.moveTo(.15, t), cc.callFunc(function(e, t) {
                    e.getComponent("Fruit").enterPath(n)
                }, this, this))),
                this.preShot()
            }
            ,
            t.prototype.autoAddFruit = function() {
                ...
                var i = this.fruitArr[this.fruitArr.length - 1]
                  , o = i.getComponent("Fruit");
                o.onPath = !0,
                o.currentAngle = e.getNextFruitAngle(o.centralAngle, this.autoAddFruitNum);
                var r = e.getNextFruitPos(o.centralAngle, this.autoAddFruitNum);
                i.setPosition(r),
                0 == this.autoAddFruitNum ? (this.insertFruitInNum(i, this.minFruitNum),
                this.autoAddFruitNum = 1) : (this.insertFruitInNum(i, this.maxFruitNum + 1),
                this.autoAddFruitNum = 0),
                o.realShadow.setScale(1),
                i.runAction(cc.sequence(cc.scaleTo(.2, 1.2).easing(cc.easeSineInOut()), cc.scaleTo(.1, 1).easing(cc.easeSineOut()), cc.callFunc(function() {
                    this.tryToOverGame()
                }, o)))
            }
            ,
            ...
            t.prototype.preShot = function() {
                var e = a.getRndInteger(0, 9, !1)
                  , t = 0;
                e < 2.5 ? t = 0 : e >= 2.5 && e < 5 ? t = 1 : e >= 5 && e < 8 ? t = 2 : e >= 8 && (t = 3),
                this.testFruitBoom && (t = this.typeArr[this.typeNum],
                this.typeNum++),
                this.createFruit(cc.v2(0, 0), t),
                this.currentFruit = this.fruitArr[this.fruitArr.length - 1],
                this.currentFruit.runAction(cc.scaleTo(.4, 1)),
                this.currentFruit.getComponent("Fruit").realShadow.runAction(cc.scaleTo(.4, 1))
            }
            ,
            t.prototype.revisePosFromNum = function(e) {
                ...
                if (t) {
                    var n = t.getComponent("Fruit")
                      , i = null
                      , o = 0;
                    if (e == this.maxFruitNum ? (i = this.findFruitByNum(e - 1),
                    o = 1) : i = this.findFruitByNum(e + 1),
                    i) {
                        var r = i.getComponent("Fruit");
                        n.canMove = !1,
                        t.setPosition(r.getNextFruitPos(n.centralAngle, o)),
                        n.currentAngle = this.judgeFruitAngle(t.position),
                        cc.log("\u4fee\u6b63\u81ea\u8eab\u4f4d\u7f6e\u6210\u529f")
                    }
                }
            }
            ...
            t.prototype.revisePosBySelf = function(e) {
                ...
                for (var t = e; t < this.maxFruitNum; t++) {
                    var n = this.findFruitByNum(t).getComponent("Fruit")
                      , i = this.findFruitByNum(t + 1)
                      , o = i.getComponent("Fruit");
                    i.setPosition(n.getNextFruitPos(o.centralAngle, 1)),
                    o.currentAngle = this.judgeFruitAngle(i.position)
                }
                for (t = e; t > this.minFruitNum; t--) {
                    n = this.findFruitByNum(t).getComponent("Fruit");
                    var r = this.findFruitByNum(t - 1)
                      , a = r.getComponent("Fruit");
                    r.setPosition(n.getNextFruitPos(a.centralAngle, 0)),
                    a.currentAngle = this.judgeFruitAngle(r.position)
                }
            }
            ,
            ...
            t.prototype.insertFruitInNum = function(e, t) {
                ...
                t > this.maxFruitNum)
                    ...
                    for (var n = 0; n < this.fruitArr.length; n++)
                        void 0 != this.fruitArr[n].num && this.fruitArr[n].num >= t && (this.fruitArr[n].num++,
                        this.fruitArr[n].num > this.maxFruitNum && (this.maxFruitNum = this.fruitArr[n].num));
                e.num = t,
                cc.log("\u5f53\u524d\u5e8f\u53f7\u6700\u5927\u4e3a" + this.maxFruitNum)
            }
            ,
            ...
            t.prototype.fruitAddSpeed = function(e, t) {
                ...
                for (var n = 0; n < this.fruitArr.length; n++) {
                    ...
                    i.onPath && this.fruitArr[n].num >= e && (i.timePerRound = 10,
                    i.speedUp = !0,
                    i.moveDir = 1,
                    this.fruitArr[n].num == e && (i.targetFruitNum = t,
                    i.running = !0))
                }
            }
            ,
            t.prototype.fruitNormalSpeedAfter = function(e) {
                for (var t = 0; t < this.fruitArr.length; t++) {
                    ...
                    n.onPath && this.fruitArr[t].num >= e && (n.timePerRound = 10,
                    n.speedUp = !1)
                }
            }
            ,
            ...
            t.prototype.createParticle = function(e, t) {
                for (var n = a.getRndInteger(25, 30, !0), i = 0; i < n; i++) {
                    ...
                    this.node.addChild(o, this.memberZIndex.particle),
                    o.getComponent(cc.Sprite).spriteFrame = i % 2 == 0 ? this.particle1SpriteFrameArr[t] : this.particle2SpriteFrameArr[t];
                    var r = e.x + a.getRndInteger(-10, 10, !1)
                      , c = e.y + a.getRndInteger(-10, 10, !1);
                    o.setPosition(cc.v2(r, c)),
                    8 == t ? o.setScale(a.getRndInteger(1, 2, !1), a.getRndInteger(1, 2, !1)) : o.setScale(a.getRndInteger(2, 3, !1), a.getRndInteger(2, 3, !1)),
                    o.opacity = a.getRndInteger(150, 255, !0),
                    o.angle = a.getRndInteger(0, 360, !1);
                    var u = a.getRndInteger(0, 360, !1)
                      , l = cc.misc.degreesToRadians(a.getRndInteger(0, 360, !0))
                      , h = a.getRndInteger(10, this.fruitWidthArr[t] + 90, !0);
            ...
            t.prototype.createRing = function(e, t) {
                var n = this
                  , i = [e, cc.v2(0, 0), cc.v2(0, 0)]
                  , o = a.getRndInteger(0, 360, !1)
                  , r = a.getRndInteger(10, 20, !1)
                  , c = o + a.getRndInteger(45, 90, !1)
                  , u = a.getRndInteger(30, 40, !1);
                i[1] = cc.v2(e.x + r * Math.cos(o), e.y + r * Math.sin(o)),
                i[2] = cc.v2(e.x + u * Math.cos(c), e.y + u * Math.sin(c));
                for (var l = function(e) {
                    setTimeout(function() {
                        var o = s.default.Spawn("ring");
                        n.node.addChild(o, n.memberZIndex.particle),
                        o.getComponent(cc.Sprite).spriteFrame = n.ringSpriteFrameArr[t],
                        o.setPosition(i[e]),
                        o.setScale(0),
                        o.runAction(cc.sequence(cc.spawn(cc.scaleTo(.6 - .1 * e, 2 - .2 * e), cc.fadeOut(.6 - .1 * e).easing(cc.easeExponentialIn())), cc.removeSelf(!0)))
                    }, .1 * e)
                }, h = 0; h < 1; h++)
                    l(h)
            }
            ...
            t.prototype.createJuice = function(e, t) {
                ...
                this.node.addChild(n, this.memberZIndex.particle),
                n.getComponent(cc.Sprite).spriteFrame = this.juiceSpriteFrameArr[t],
                n.setPosition(e),
                n.setScale(0),
                n.angle = a.getRndInteger(0, 360, !1);
            ...
            t.prototype.createFloatScore = function(e, t) {
                ...
                this.node.addChild(n, this.memberZIndex.particle),
                n.setPosition(e),
                n.getComponent("FloatScore").init(t)
            }
            ,
            t.prototype.createWatermelon = function(e) {
                for (var t = 0; t < a.getRndInteger(40, 50, !0); t++) {
                    var n = new cc.Node;
                    this.node.addChild(n, this.memberZIndex.watermelon),
                    n.setPosition(cc.v2(e.x + a.getRndInteger(-60, 60, !1), e.y + a.getRndInteger(-60, 60, !1))),
                    n.setScale(.1 + .021 * t),
                    n.angle = a.getRndInteger(0, 360, !1),
                    n.addComponent(cc.Sprite).spriteFrame = this.watermelonSpriteFrameArr[a.getRndInteger(0, 4, !0)];
                    ...
                    var o = this.MainGame.gameHeight
                      , r = cc.v2(n.x + o * Math.cos(i), n.y + o * Math.sin(i))
                      , c = 0;
                    c = r.x < n.x ? 200 * a.getRndInteger(2, 5, !1) : 200 * a.getRndInteger(-5, -2, !1);
                    n.y,
                    a.getRndInteger(100, 300, !1);
            ...
            t.prototype.judgeGameEnd = function() {
                ...
                if (cc.log("\u68c0\u6d4b\u6e38\u620f\u80fd\u5426\u7ed3\u675f" + t),
                t >= 359) {
                    var o = this.findFruitByNum(this.minFruitNum)
                      , r = this.findFruitByNum(this.maxFruitNum);
                    o.getChildByName("sprite").runAction(cc.sequence(cc.tintTo(.5, 255, 0, 0), cc.tintTo(.5, 255, 255, 255), cc.tintTo(.5, 255, 0, 0), cc.tintTo(.5, 255, 255, 255))),
                    r.getChildByName("sprite").runAction(cc.sequence(cc.tintTo(.5, 255, 0, 0), cc.tintTo(.5, 255, 255, 255), cc.tintTo(.5, 255, 0, 0), cc.tintTo(.5, 255, 255, 255)));
                    var c = o.getComponent("Fruit")
                      , s = r.getComponent("Fruit");
                    if (c.type >= s.type) {
                        (d = new l).center = a.localConvertWorldPointAR(r),
                        d.radius = s.radius + c.radius;
                        var u = this.findFruitByNum(this.minFruitNum + 1);
                        (g = new l).center = a.localConvertWorldPointAR(u),
                        g.radius = u.getComponent("Fruit").radius + c.radius;
                        ...
                        var d;
                        (d = new l).center = a.localConvertWorldPointAR(o),
                        d.radius = c.radius + s.radius;
                        var g, m = this.findFruitByNum(this.maxFruitNum - 1);
                        (g = new l).center = a.localConvertWorldPointAR(m),
                        g.radius = m.getComponent("Fruit").radius + s.radius;
            ...
            t.prototype.getCircleIntersection = function(e, t) {
                ...
                n = o + g * (s - o) / h,
                i = r + g * (u - r) / h;
                var m = Math.sqrt(Math.pow(c, 2) - Math.pow(g, 2))
                  , p = cc.v2(0, 0)
                  , f = cc.v2(0, 0);
                return p.x = n - m / Math.sqrt(1 + Math.pow(d, 2)),
                p.y = i + d * (p.x - n),
                f.x = n + m / Math.sqrt(1 + Math.pow(d, 2)),
                f.y = i + d * (f.x - n),
                p.sub(a.localConvertWorldPointAR(this.node)).mag() > f.sub(a.localConvertWorldPointAR(this.node)).mag() ? p : f
            }
            ,
            t.prototype.gameEnd = function() {
                if (this._curState != r.GS_END) {
                    this._curState = r.GS_END,
                    cc.log("\u6e38\u620f\u7ed3\u675f"),
                    c.updateOver = !0,
                    c.noTouchBool = !1;
                    ...
                    this.node.runAction(cc.sequence(cc.delayTime(t), cc.callFunc(function() {
                        this.MainGame.gameEnd()
                    }, this)))
                }
            }
            ,
            t.prototype.destroyAllFruit = function() {
                this.currentFruit.stopAllActions(),
                this.currentFruit.runAction(cc.sequence(cc.scaleTo(.2, 1.2), cc.scaleTo(.1, 0), cc.removeSelf(!0))),
                this.currentFruit.getComponent("Fruit").realShadow.destroy();
                for (var e = 0; e < this.fruitArr.length; e++)
                    this.fruitArr[e] != this.currentFruit && this.fruitArr[e].runAction(cc.sequence(cc.delayTime(.1 * e), cc.callFunc(function(e) {
                        e.getComponent("Fruit").boom()
                    }, this)))
            }
            ,
            t.Instance = null,
          ...
          , u = function(e) {
            ...
            t.prototype.onLoad = function() {
                ...
                for (var e = 0; e < 80; e++) {
                    ...
                    t.getComponent(cc.Sprite).spriteFrame = this.ribbonSpriteFrame[r.getRndInteger(0, 4, !0)],
                    this.ribbonPool.put(t)
                }
            }
            ,
            t.prototype.start = function() {}
            ...
            t.prototype.createRibbon = function(e) {
                for (var t = [[360, 0], [-360, 0], [360, -71], [-360, -71]], n = 0; n < t.length; n++) {
                    ...
                    for (var o = 0; o < e; o++) {
                        var a = null;
                        (a = this.ribbonPool.size() > 0 ? this.ribbonPool.get() : cc.instantiate(this.ribbonPre)).parent = this.node,
                        a.setPosition(cc.v2(t[n][0], t[n][1])),
                        this.ribbonArr.push(a);
                        var c = a.position
                          , s = c.x + r.getRndInteger(.5 * -cc.winSize.width, .05 * -cc.winSize.width, !0) * i
                          , u = c.y + r.getRndInteger(100, 500, !0)
                          , l = cc.v2(c.x + .8 * (s - c.x), c.y + .5 * (u - c.y) + 200);
            ...
            t.prototype.init = function() {
                return r(this, void 0, void 0, function() {
                    return a(this, function(e) {
                        return this.sprite = this.node.getComponent(cc.Sprite),
        ...
        var i = {
            ...
            writeJson: function(e, t) {
                if (cc.sys.isBrowser) {
                    ...
                    null != window.webkitURL ? i.href = window.webkitURL.createObjectURL(n) : (i.href = window.URL.createObjectURL(n),
    ...
    UIManager: [function(e, t, n) {
        ...
        cc.Class({
            ...
            properties: {
                mainGame: cc.Node,
                startGamePlanel: cc.Node,
                Particale: cc.Node,
                FloatScore: cc.Node,
                maskFloor: cc.Node,
                gameOverInfo: cc.Node,
                gameOverPanel: cc.Node,
                continue: cc.Node,
                hand: cc.Node,
                gameSuccessPanel: cc.Node,
                di: cc.Node,
                guan: cc.Node,
                handSpriteFrame: [cc.SpriteFrame],
                lv: cc.Label,
                gameMaxScore: cc.Label,
                overInfoT: cc.Label,
                score: cc.Label,
                moreBtn: cc.Button
            },
            onLoad: function() {
                this.MainGame = this.mainGame.getComponent("MainGameJS"),
                this.handSprite = this.hand.getComponent(cc.Sprite),
                this.scaleHeight = this.MainGame.gameHeight / 1280,
                this.gameSuccessPanel.y = this.MainGame.gameHeight / 2 + 145,
                this.moreBtn.node.x = -this.MainGame.gameWidth / 2 + 95,
                this.moreBtn.node.y = this.MainGame.gameHeight / 2 - 120,
                this.score.node.y = 300 * this.scaleHeight,
                this.gameOverPanel.getChildByName("info").y = 160 * this.scaleHeight,
                this.gameOverPanel.getChildByName("button").y = -this.MainGame.gameHeight / 4,
                this.standardScore = r.standScore,
                this.canNotTouch = !0,
                this.game_max_score = 3e3,
                this.over = !1,
                this.gameOverInfo1StringArr = ["\u6e38  \u620f  \u7ed3  \u675f", "\u904a  \u6232  \u7d50  \u675f", "Game Over", "\uac8c\uc784 \ub05d"],
                this.gameOverInfo2StringArr = ["\u70b9 \u51fb \u67e5 \u770b \u5206 \u6570", "\u9ede \u64ca \u67e5 \u770b \u5206 \u6578", "Click to view points", "\ud3ec\uc778\ud2b8\ub97c \ubcf4\ub824\uba74 \ud074\ub9ad\ud558\uc138\uc694"],
                this.gameSuccessTitleStringArr = ["\u606d \u559c \u4f60 \u5df2 \u7a81 \u7834", "\u606d \u559c \u4f60 \u5df2 \u7a81 \u7834", "Level Up", "\ub808\ubca8 \uc5c5"],
                this.gameSuccessUintStringArr = ["\u5206", "\u5206", "P", "\ubd84"],
                this.continueStringArr = ["\u70b9\u51fb\u7ee7\u7eed", "\u9ede\u64ca\u7e7c\u7e8c", "Click to continue", "\uacc4\uc18d\ud558\ub824\uba74 \ud074\ub9ad\ud558\uc138\uc694"],
                this.moreGameStringArr = ["\u66f4\u591a\u6e38\u620f", "\u66f4\u591a\u904a\u6232", "More Game", "\ub354 \ub9ce\uc740 \uac8c\uc784"],
                this.maxScoreStringArr = ["\u6700\u9ad8\u5f97\u5206\uff1a", "\u6700\u9ad8\u5f97\u5206\uff1a", "Highest score:", "\ucd5c\uace0 \uc810\uc218 :"],
                this.langNumType = this.returnCurrentLanType(),
                this.continue.getComponent(cc.Label).string = this.continueStringArr[this.langNumType - 1],
                this.gameOverInfo.children[0].getComponent(cc.Label).string = this.gameOverInfo1StringArr[this.langNumType - 1],
                this.gameOverInfo.children[1].getComponent(cc.Label).string = this.gameOverInfo2StringArr[this.langNumType - 1],
                this.addClickBtns()
            },
            start: function() {},
            beginnerHandAction: function(e) {
                this.hand.active = !0,
                r.noTouchBool = !0,
                this.hand.setPosition(cc.v2(e.x + 50, e.y - 20)),
                this.handSprite.spriteFrame = this.handSpriteFrame[0],
                this.hand.runAction(cc.repeatForever(cc.sequence(cc.delayTime(.5), cc.callFunc(function() {
                    this.handSprite.spriteFrame = this.handSpriteFrame[1]
                ...
                var e = this
                  , t = {
                    ...
                    onTouchBegan: function(t, n) {
                        if (!e.canNotTouch)
                            return e.MainGame.gameOver && i.loadingScene("MainGameScene"),
                            !0
                    },
            ...
            initGameSuccessPanel: function() {
                this.gameSuccessPanel.y = this.MainGame.gameHeight / 2 + 416,
                this.gameSuccessPanel.opacity = 0,
                this.gameSuccessPanel.active = !1,
                this.continue.stopAllActions(),
                this.continue.active = !1,
                this.continue.opacity = 255,
                this.maskFloor.active = !1
            },
            gameSuccessAction: function() {
                this.maskFloor.active = !0,
                this.MainGame.sceneScore.node.active = !1,
                this.lv.string = this.MainGame.gameScore.toString(),
                this.MainGame.gameScore >= 10 && this.MainGame.gameScore < 100 ? (this.di.x = -95,
                this.guan.x = 95) : this.MainGame.gameScore >= 100 && this.MainGame.gameScore < 1e3 ? (this.di.x = -115,
                this.guan.x = 115) : this.MainGame.gameScore >= 1e3 && this.MainGame.gameScore < 1e4 ? (this.di.x = -135,
                this.guan.x = 135) : this.MainGame.gameScore >= 1e4 && this.MainGame.gameScore < 1e5 ? (this.di.x = -155,
                this.guan.x = 155) : this.MainGame.gameScore >= 1e5 && this.MainGame.gameScore < 1e6 ? (this.di.x = -180,
                this.guan.x = 180) : this.MainGame.gameScore >= 1e6 && (this.di.x = -200,
                this.guan.x = 200),
                this.gameSuccessPanel.active = !0,
                this.gameSuccessPanel.runAction(cc.sequence(cc.spawn(cc.fadeIn(.2), cc.moveTo(.2, cc.v2(0, 50))), cc.moveTo(.1, cc.v2(0, 110)), cc.moveTo(.1, cc.v2(0, 100)), cc.callFunc(function() {
                    this.continue.active = !0,
                    this.continue.setPosition(cc.v2(0, -150)),
                    this.continue.runAction(cc.repeatForever(cc.sequence(cc.fadeTo(.7, 50), cc.fadeTo(.7, 255)))),
                    this.canNotTouch = !1
                }, this)))
            },
            gameOver: function() {
                this.maskFloor.active = !0,
                this.MainGame.sceneScore.node.active = !1,
                this.gameOverInfo.active = !0,
                this.gameOverInfo.runAction(cc.sequence(cc.delayTime(.2), cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.callFunc(function() {
                    this.canNotTouch = !1
                }, this)))
            },
            gameOverAction: function() {
                this.over || (this.over = !0,
                this.score.string = this.MainGame.gameScore.toString(),
                this.gameMaxScore.string = r.gameMaxScore.toString(),
                r.gameMaxScore >= 1e4 && r.gameMaxScore < 1e5 ? (this.gameOverPanel.getChildByName("info").children[0].x = -92,
                this.gameOverPanel.getChildByName("info").children[1].x = 36) : (this.gameOverPanel.getChildByName("info").children[0].x = -110,
                this.gameOverPanel.getChildByName("info").children[1].x = 36),
                this.UIPosChange(),
                this.gameOverPanel.active = !0,
                this.gameOverPanel.runAction(cc.sequence(cc.fadeIn(.2), cc.callFunc(function() {
                    this.gameOverPanel.getChildByName("button").runAction(cc.repeatForever(cc.sequence(cc.delayTime(2), cc.rotateTo(.2, 10), cc.rotateTo(.4, -10), cc.rotateTo(.4, 10), cc.rotateTo(.4, -10), cc.rotateTo(.2, 0), cc.delayTime(2), cc.scaleTo(.5, 1.2), cc.scaleTo(.5, 1), cc.scaleTo(.5, 1.2), cc.scaleTo(.5, 1)))),
                    this.canNotTouch = !1
                }, this))))
            },
            addClickBtns: function() {
                ...
                e.gameSuccessPanel.on(cc.Node.EventType.TOUCH_START, function(e) {}),
                e.gameSuccessPanel.on(cc.Node.EventType.TOUCH_END, function(t) {
                    e.canNotTouch || (r.noTouchBool = !0,
                    e.canNotTouch = !0,
                    r.publicGameBool || adBreak({
                        type: "next",
                        name: "restart-game"
                    }),
                    e.initGameSuccessPanel())
                }),
                e.gameOverInfo.on(cc.Node.EventType.TOUCH_START, function(e) {}),
                e.gameOverInfo.on(cc.Node.EventType.TOUCH_END, function(t) {
                    e.canNotTouch || (r.publicGameBool || adBreak({
                        type: "next",
                        name: "restart-game"
                    }),
                    e.gameOverAction(),
                    e.gameOverInfo.destroy())
                }),
                e.gameOverPanel.on(cc.Node.EventType.TOUCH_START, function(e) {}),
                e.gameOverPanel.on(cc.Node.EventType.TOUCH_END, function(t) {
                    e.canNotTouch || (r.publicGameBool || adBreak({
                        type: "next",
                        name: "restart-game"
                    }),
            ...
            UIPosChange: function() {
                ...
                var e = null
                  , t = null;
                1 == o.langugeType ? (e = this.getContentByScore(r.gameScore, o.gameNameText, !0),
                t = this.getContentByScore(r.gameScore, o.gameNameText, !1)) : (e = this.getContentByScore2(r.gameScore, o.gameNameText, !0),
                t = this.getContentByScore(r.gameScore, o.gameNameText, !1)),
                console.log("nihao", o.endHttpShowInfo),
                null != o.endHttpShowInfo && "" != o.endHttpShowInfo && (cc.log("gototo"),
                t = o.endHttpShowInfo),
            ...
            getContentByScore: function(e, t, n) {
                var i = "\u6211\u771f\u662f\u592a\u5389\u5bb3\uff0c\u5728" + t + "\u4e2d\u7adf\u7136\u5f97\u4e860\u5206\uff0c\u5168\u7403\u53ea\u67091\u4e2a\u4eba\u5f970\u5206\uff01"
                  , o = "\u51fb\u8d25\u4e86\u5168\u74030%\u7684\u73a9\u5bb6\uff01";
                if (e >= 0 && e <= 200)
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u5f97\u5fc3\u5e94\u624b!",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403" + Math.floor(10 * e / 200) + "%\u7684\u73a9\u5bb6\uff01";
                else if (e > 200 && e <= this.standardScore) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u8fbe\u5230\u6e38\u5203\u6709\u4f59\u7684\u5883\u754c\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403" + (Math.floor(10 * (e - this.standardScore) / (200 - this.standardScore)) + 40) + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > this.standardScore && e <= 500) {
                    var r = Math.floor(20 * (e - this.standardScore) / (500 - this.standardScore)) + 50;
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + r + "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u4fe1\u624b\u62c8\u6765\u7684\u5883\u754c\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403" + r + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > 500 && e <= 1300) {
                    var a = Math.floor(15 * (e - 500) / 800) + 70;
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + a + "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u8fd0\u7528\u81ea\u5982\u7684\u5883\u754c\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403" + a + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > 1300 && e <= 2700) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u884c\u4e91\u6d41\u6c34\u7684\u5883\u754c\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403" + (Math.floor(10 * (e - 1300) / 1400) + 85) + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > 2700 && e < this.game_max_score) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 " + (20 - Math.ceil(17 * (e - 2700) / (this.game_max_score - 2700))) + "\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff0c\u72ec\u5b64\u6c42\u8d25\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff01"
                } else
                    e >= this.game_max_score && (i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u8d85\u8d8a\u4e86\u72ec\u5b64\u6c42\u8d25\uff0c\u5fc3\u6709\u7075\u7280\uff01",
                    o = "\u51fb\u8d25\u4e86\u5168\u7403100%\u7684\u73a9\u5bb6\uff01");
                return n ? o : i
            },
            getContentByScore2: function(e, t, n) {
                var i = "I'm awesome\uff0cin" + t + "get 0 score\uff0conly one person in the world has a 0\uff01"
                  , o = "Only 0 points, the only one in the world!";
                if (e >= 0 && e <= 300)
                    i = "I got " + e + " points in the game, really great\uff01",
                    o = "Defeated " + Math.floor(10 * e / 300) + "% of players worldwide!";
                else if (e > 300 && e <= this.standardScore) {
                    i = "I got " + e + " points in the game, really great\uff01",
                    o = "Defeated " + (Math.floor(10 * (e - this.standardScore) / (300 - this.standardScore)) + 40) + "% of players worldwide!"
                } else if (e > this.standardScore && e <= 600) {
                    var r = Math.floor(20 * (e - this.standardScore) / (600 - this.standardScore)) + 50;
                    i = "I got in the game in " + e + " points, beating out " + r + "% of global players\uff01",
                    o = "Defeated " + r + "% of players worldwide!"
                } else if (e > 600 && e <= 1700) {
                    var a = Math.floor(15 * (e - 600) / 1100) + 70;
                    i = "I got in the game in " + e + " points, beating out " + a + "% of global players\uff01",
                    o = "Defeated " + a + "% of players worldwide!"
                } else if (e > 1700 && e <= 2700) {
                    i = "I got in the game in " + e + " points, beating out 99% of global players\uff01",
                    o = "Defeated " + (Math.floor(10 * (e - 1700) / 1e3) + 85) + "% of players worldwide!"
                } else if (e > 2700 && e < this.game_max_score) {
                    i = "I got " + e + " points in the game, it said to be the world's only " + (20 - Math.ceil(17 * (e - 2700) / (this.game_max_score - 2700))) + " people to reach this level! Have you?",
                    o = "Defeated 99% of players worldwide!"
                } else
                    e >= this.game_max_score && (i = "I got " + e + " points in the game, defeating all players worldwide, waiting for you to fight!",
                    o = "Defeated 100% of players worldwide!");
                return n ? o : i
            },
            getContentByScore3: function(e, t, n) {
                ...
                if (e >= 0 && e <= 300)
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u5f97\u5fc3\u5e94\u624b!",
                    o = "\u64ca\u6557\u4e86\u5168\u7403" + Math.floor(10 * e / 300) + "%\u7684\u73a9\u5bb6\uff01";
                else if (e > 300 && e <= this.standardScore) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u8fbe\u5230\u6e38\u5203\u6709\u4f59\u7684\u5883\u754c\uff01",
                    o = "\u64ca\u6557\u4e86\u5168\u7403" + (Math.floor(10 * (e - this.standardScore) / (300 - this.standardScore)) + 40) + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > this.standardScore && e <= 600) {
                    var r = Math.floor(20 * (e - this.standardScore) / (600 - this.standardScore)) + 50;
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + r + "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u4fe1\u624b\u62c8\u6765\u7684\u5883\u754c\uff01",
                    o = "\u64ca\u6557\u4e86\u5168\u7403" + r + "%\u7684\u73a9\u5bb6\uff01"
                    ...
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u884c\u4e91\u6d41\u6c34\u7684\u5883\u754c\uff01",
                    o = "\u64ca\u6557\u4e86\u5168\u7403" + (Math.floor(10 * (e - 1700) / 1e3) + 85) + "%\u7684\u73a9\u5bb6\uff01"
                } else if (e > 2700 && e < this.game_max_score) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 " + (20 - Math.ceil(17 * (e - 2700) / (this.game_max_score - 2700))) + "\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff0c\u72ec\u5b64\u6c42\u8d25\uff01",
                    o = "\u64ca\u6557\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff01"
                } else
            ...
            getContentByScore4: function(e, t, n) {
                var i = "\u6211\u771f\u662f\u592a\u5389\u5bb3\uff0c\u5728" + t + "\u4e2d\u7adf\u7136\u5f97\u4e860\u5206\uff0c\u5168\u7403\u53ea\u67091\u4e2a\u4eba\u5f970\u5206\uff01"
                  , o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 0%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!";
                if (e >= 0 && e <= 300)
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u5f97\u5fc3\u5e94\u624b!",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 " + Math.floor(10 * e / 300) + "%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!";
                else if (e > 300 && e <= this.standardScore) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u80fd\u8fbe\u5230\u6e38\u5203\u6709\u4f59\u7684\u5883\u754c\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 " + (Math.floor(10 * (e - this.standardScore) / (300 - this.standardScore)) + 40) + "%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!"
                } else if (e > this.standardScore && e <= 600) {
                    var r = Math.floor(20 * (e - this.standardScore) / (600 - this.standardScore)) + 50;
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + r + "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u4fe1\u624b\u62c8\u6765\u7684\u5883\u754c\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 " + r + "%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!"
                } else if (e > 600 && e <= 1700) {
                    var a = Math.floor(15 * (e - 600) / 1100) + 70;
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + a + "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u8fd0\u7528\u81ea\u5982\u7684\u5883\u754c\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 " + a + "%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!"
                } else if (e > 1700 && e <= 2700) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u884c\u4e91\u6d41\u6c34\u7684\u5883\u754c\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 " + (Math.floor(10 * (e - 1700) / 1e3) + 85) + "%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!"
                } else if (e > 2700 && e < this.game_max_score) {
                    i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 " + (20 - Math.ceil(17 * (e - 2700) / (this.game_max_score - 2700))) + "\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff0c\u72ec\u5b64\u6c42\u8d25\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 99%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!"
                } else
                    e >= this.game_max_score && (i = "\u6211\u5728" + t + "\u4e2d\u5f97\u4e86" + e + "\u5206\uff0c\u8d85\u8d8a\u4e86\u72ec\u5b64\u6c42\u8d25\uff0c\u5fc3\u6709\u7075\u7280\uff01",
                    o = "\uc804 \uc138\uacc4 \ud50c\ub808\uc774\uc5b4 100%\ub97c \ubb3c\ub9ac \ucce4\uc2b5\ub2c8\ub2e4!");
                return n ? o : i
            },
            update: function(e) {}
        }),
    ...
    gameOverJs: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.standardScore = o.standScore,
                ...
                var n = o.gameScore
                  , i = this.getHighScore();
                i ? i < o.gameScore && (this.setHisSocre(o.gameScore),
                i = o.gameScore) : (this.setHisSocre(o.gameScore),
                i = n),
            ...
            UIPosChange: function() {
                this.overScoreT.string = o.gameScore,
                console.log("lang", r.langugeType);
                var e = null;
                e = 1 == r.langugeType ? this.getContentByScore(o.gameScore, r.gameNameText) : this.getContentByScore2(o.gameScore, r.gameNameText),
                console.log("nihao", r.endHttpShowInfo),
                null != r.endHttpShowInfo && "" != r.endHttpShowInfo && (cc.log("gototo"),
                e = r.endHttpShowInfo),
                this.overInfoT.string = e;
                ...
                document.title = e,
                console.log("gameOver txtMoreText", r.txtMoreText),
                this.midGameText.string = r.txtMoreText,
                this.leftBtnText.string = r.txtAgainText,
                this.tempArr = this.gameFocus(),
                null != r.ranLinkUrl()) {
                    var n = r.ranLinkUrl()
                      , i = r.ranLinkData.gameList[n].gameName;
                    this.rigthBtnGameName = i,
                    this.rightBtnGameUrl = r.ranLinkData.gameList[n].gameUrl
                }
            ...
            gameFocus: function() {
                var e = []
                  , t = null
                  , n = null;
                return Math.random() <= .5 ? (t = r.gameEndName1,
                n = r.gameEndUrl1) : (t = r.gameEndName2,
                n = r.gameEndUrl2),
                e.push(t),
                e.push(n),
                e
            ...
            addClickBtns: function() {
                ...
                e.moreBtn.node.on(cc.Node.EventType.TOUCH_END, function(e) {
                    console.log("MoreGame"),
                    window.location.href = r.moreGameUrl
                }),
            ...
            onLoad: function() {
                ...
                null != i.recGameData && "" != i.recGameData && null != i.recGameimg1 && "" != i.recGameimg1) {
                    ...
                    cc.loader.load(o, function(n, i) {
                        a.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(i),
                  ...
                  , t = {
                    ...
                    onTouchBegan: function(t, n) {
                        ...
                        if (e._imageArr.length >= 2) {
                            var a = Math.abs(r.x - e.gameWidth / 2 - e._imageArr[0].x)
                              , c = Math.abs(r.y - e.gameHeight / 2 - e._imageArr[0].y);
                            a <= 30 && c <= 30 && (o.noTouchBool = !1,
    ...
    resArr: [function(e, t, n) {
        "use strict";
        cc._RF.push(t, "36b14EoJxtHtJEeP2jXVvPf", "resArr"),
        cc.Class({
            extends: cc.Component,
            properties: {
    ...
    startGameJs: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                r.publicGameBool && o.init(),
                this.showInfoT.string = o.gameInfoText,
                this.startT.string = o.txtStartText,
            ...
            addTouchEvents: function() {
                var e = {
                    ...
                    onTouchBegan: function(e, t) {
                        return i.loadingScene("MainGameScene"),
                        !0
                    },
                    onTouchMoved: function(e, t) {},
                    onTouchEnded: function(e, t) {}
    ...
    "use_v2.1.x_cc.Action": [function(e, t, n) {
        "use strict";
        cc._RF.push(t, "c382eNvNvFEVqcM3zUHzwkK", "use_v2.1.x_cc.Action"),
